            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    @if ($isEnrolled == 0)
                        @if ($student->application_status == 1)
                            @if ($notCleared == '1')
                                <div class="alert alert-danger mt-3 fade show  d-flex justify-content-between">
                                    <span>Please settle your pending accountabilities first.</span>
                                </div>
                            @else
                        ...
                        @else
                            <div class="alert alert-danger mt-3 fade show  d-flex justify-content-between">
                                <span>Your admission application has not been approved yet. Application
                                    must be
                                    accepted by the school first before you can enroll for courses.</span>
                            </div>
                        @endif
                    @else
                        <div class="alert alert-warning mt-3 fade show  d-flex justify-content-between">
                            <span>You are already currently enrolled for current academic schedule</span>
                        </div>
                    @endif
                </div>
            </div>
